...
// File: contracts/TREMISSToken.sol

contract TREMISSToken is MintableToken {

  string public constant name = "TREMISS";
...
// File: contracts/TREMISS.sol

contract TREMISSCommonSale is ValueBonusFeature, RetrieveTokensFeature, ReferersRewardFeature {
...
contract Mainsale is StagedCrowdsale, TREMISSCommonSale {
...
contract Presale is TREMISSCommonSale {
...
contract Configurator is Ownable {
  ...
  function deploy() public onlyOwner {
    ...
    token = new TREMISSToken();

    presale = new Presale();

    presale.setWallet(0x5E94b66FF0985f55E16f9FBc8EfacBBC61174b34);
    presale.setStart(1551052800);
    presale.setPeriod(65);
    presale.setPrice(2000000000000000000000);
    ...
    mainsale.addMilestone(15, 25);
    mainsale.addMilestone(15, 17);
    mainsale.addMilestone(15, 10);
    mainsale.addMilestone(15, 5);
    mainsale.addMilestone(100, 0);
    mainsale.setPrice(1000000000000000000000);
    mainsale.setWallet(0x5E94b66FF0985f55E16f9FBc8EfacBBC61174b34);
    mainsale.setFoundersTokensWallet(0x0368D84B484caB87c35c6dC587b2E2B8C4379A17);
    mainsale.setMarketingTokensWallet(0xC6A41Dcd4684336F69E07bcB2Bff5915f67762Ed);
    mainsale.setBountyTokensWallet(0x18449b373Da3393d1fc8E704F6C95b47c9C9F050);
    mainsale.setStart(1555027200);
    mainsale.setHardcap(90000000000000000000000);
    mainsale.setFoundersTokensPercent(60);
    mainsale.setMarketingTokensPercent(10);
    mainsale.setBountyTokensPercent(30);
  ...
  function commonConfigure(address saleAddress, address _token) internal {
     TREMISSCommonSale sale = TREMISSCommonSale(saleAddress);
     sale.addValueBonus(1000000000000000000, 10);
     sale.addValueBonus(5000000000000000000, 15);
     sale.addValueBonus(10000000000000000000, 25);
     sale.setReferalsMinInvestLimit(500000000000000000);
     sale.setRefererPercent(10);
     sale.setMinInvestedLimit(50000000000000000);
